...
import ToggleCommentSection from "@/features/comments/components/ToggleCommentSection"
import { getComments } from "@/features/comments/lib/requests"
...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <>
      ...
      <ToggleCommentSection comments={comments} />
    </>
  )
}
